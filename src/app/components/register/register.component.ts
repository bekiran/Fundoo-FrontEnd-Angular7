...
export class RegisterComponent implements OnInit {
  ...
  constructor(private service:HttpService, private snackBar: MatSnackBar, private router: Router, public userService:UserService) { }
...
register(){
    ...
    console.log(reqbody);
    this.userService.register(reqbody).subscribe(data=>{
      console.log(data);
